...
ProfileComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ProfileComponent, selectors: [["ngx-profile"]], decls: 14, vars: 3, consts: [[1, "row", "w-100"], [1, "col-6"], ["class", "row", 4, "ngFor", "ngForOf"], ["src", "https://th.bing.com/th/id/OIP.urs9CLtRNkSZtaP2K1uOIAHaHa?pid=ImgDet&rs=1", "alt", "profile name", "width", "50%", 1, "img-thumbnail", "rounded", "mx-auto", "d-block", 2, "cursor", "pointer"], ["type", "hidden", "value", "0"], ["editProfile", ""], ["nbButton", "", 3, "status", "click"], [1, "row"], [1, "col-5", "my-2"], [1, "col-2", "my-2"], ["class", "col-5 my-2", 4, "ngIf"], ["class", "col-5", 4, "ngIf"], [1, "col-5"], ["nbInput", "", "type", "text", "fieldSize", "small", 3, "placeholder", "ngModel"]], template: function ProfileComponent_Template(rf, ctx) { if (rf & 1) {
